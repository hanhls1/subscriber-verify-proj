...
public class RestUtils {
    ...
    public static <Res> RestResponse<Res> exchange(
            String url, HttpMethod method, Map<String, String> headers, Object requestBody, Class<Res> resClass) {
    ...
    public static <Res> RestResponse<Res> post(
            String url, Map<String, Object> params, Class<Res> resClass) {
        return exchange(urlWithQueryParams(url, params), HttpMethod.POST, null, null, resClass);
    }
    ...
    public static class RestResponse<Res> {
        ...
        public RestResponse(ResponseEntity<Res> resEntity, String responseMsg, long takeTime) {
            this();
            this.responseBody = resEntity.getBody();
            this.responseHeaders = resEntity.getHeaders();
        ...
        public Res getResponseBody() {
            return responseBody;
        }

        public void setResponseBody(Res responseBody) {
